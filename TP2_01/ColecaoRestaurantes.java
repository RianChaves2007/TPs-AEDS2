...
/**
 * Para este exercício,
 * dispensei a necessidade de setters.
 * Mas inclui todos os getters.
 * Em exercícios próximos os setters poderão
 * ser incluídos.
 */
...
public class ColecaoRestaurantes {
    ...
    public static ColecaoRestaurantes lerCsv() {
        ...
        String path = "C:\\tmp\\restaurantes.csv";
    ...
    public static void main(String[] args) {
        ...
        while(sc.hasNext() && (id = sc.nextInt())!=(-1)){
            System.out.println(col.buscarPorId(id).formatar());
        }
